...
public class TutorialTwo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tutorial_two_layout);
        TextView textViewInfo = (TextView) findViewById(R.id.todoInfoTaskExample);
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        switch (item.getItemId()) {
                            case R.id.move_to_doing:
                                Toast.makeText(v.getContext(), "Task Moved to In Process", Toast.LENGTH_SHORT).show();
                                break;
                            case R.id.delete:
